...
\begin{figure}
  ...
  \caption{Evaluation Time for a Line (ms) vs. the Number of
    ...
    Nested Spheres test scenes on the Gentoo machine; {\bf X's:
...
A problem left unsolved here is how to compute the quadric
intersection order correctly when the order of mutliple roots are
undetermined.  This can be done with the resultant and some minor
amount of algebra, but has not been evaluated
